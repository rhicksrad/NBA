...
const preseasonPowerIndex = [
  {
    ...
    tier: 'Title favorite',
    note: 'Fresh off delivering Oklahoma City’s first championship, Shai Gilgeous-Alexander, Jalen Williams, and Chet Holmgren enter camp with championship reps, while Isaiah Hartenstein’s arrival fortifies the interior.',
  },
  {
    team: 'Boston Celtics',
    tier: 'Title favorite',
    note: 'Jayson Tatum and Jaylen Brown return from a Finals defeat with a deeper bench, Jrue Holiday and Derrick White remain the guard anchors, and Kristaps Porziņģis is on track for opening night after a managed postseason.',
  },
  {
    team: 'Minnesota Timberwolves',
    tier: 'Title favorite',
    note: 'Anthony Edwards’ playoff breakout, Rudy Gobert’s fifth DPOY push, and veteran backcourt additions around Mike Conley give Minnesota a continuity plus creation blend that mirrors title-level depth.',
  },
  {
    team: 'Denver Nuggets',
    tier: 'Title hopeful',
    note: 'Nikola Jokić and Jamal Murray are healthy after a lighter summer, Peyton Watson and Christian Braun looked ready for larger roles, and Denver’s mid-level additions replaced the bench offense that sagged last spring.',
  },
  {
    team: 'New York Knicks',
    tier: 'Title hopeful',
    note: 'Jalen Brunson now leads the reigning East No. 1 seed with Mikal Bridges and OG Anunoby defending the arc, Julius Randle cleared contact in August, and a Donte DiVincenzo-led bench keeps the spacing steady.',
  },
  {
    team: 'Philadelphia 76ers',
    tier: 'Title hopeful',
    note: 'Joel Embiid exited summer workouts without restrictions, Tyrese Maxey is coming off an All-NBA leap, and new switchable wings Caleb Martin and Kelly Oubre Jr. give Nick Nurse fresh defensive looks.',
  },
  {
    team: 'Milwaukee Bucks',
    tier: 'Title hopeful',
    note: 'Giannis Antetokounmpo and Damian Lillard finally get a full offseason together, Brook Lopez remains the safety net, and Doc Rivers’ second camp is focused on rebuilding a top-10 defense.',
  },
  {
    team: 'Dallas Mavericks',
    tier: 'Contender',
    note: 'Luka Dončić’s MVP run now features Naji Marshall and Derrick Jones Jr. keeping the wing defense rugged, Dereck Lively II is a year stronger, and Dallas’ retooled second unit keeps the pace sustainable.',
  },
  {
    team: 'Memphis Grizzlies',
    tier: 'Contender',
    note: 'Ja Morant’s shoulder rehab finished in July, Desmond Bane and Jaren Jackson Jr. are healthy, and a veteran combo guard rotation of Marcus Smart and Luke Kennard balances the offense.',
  },
  {
    team: 'Cleveland Cavaliers',
    tier: 'Contender',
    note: 'Donovan Mitchell recommitted long term, Evan Mobley’s expanded frame supports more small-ball five possessions, and Kenny Atkinson’s motion offense unlocked top-10 efficiency after the All-Star break.',
  },
  {
    team: 'Orlando Magic',
    tier: 'Playoff lock',
    note: 'Paolo Banchero and Franz Wagner headline a defense-first core, Jalen Suggs and Kentavious Caldwell-Pope stretch the floor, and a top-five defense adds real half-court shooting for the first time in this climb.',
  },
  {
    team: 'Phoenix Suns',
    tier: 'Playoff lock',
    note: 'Kevin Durant, Devin Booker, and Bradley Beal are finally entering a camp fully healthy, Mike Budenholzer is layering more movement shooting, and Jusuf Nurkić’s conditioning jump stabilizes the paint.',
  },
  {
    team: 'Los Angeles Lakers',
    tier: 'Playoff lock',
    note: 'LeBron James committed to season 23, Anthony Davis is carrying Defensive Player of the Year momentum, and JJ Redick’s staff added floor spacing via Buddy Hield to modernize the half-court attack.',
  },
  {
    team: 'Sacramento Kings',
    tier: 'Playoff lock',
    note: 'De’Aaron Fox and Domantas Sabonis still torch regular-season coverages, Keegan Murray’s on-ball creation spike is real, and Malik Monk’s return keeps the league’s best second-unit offense intact.',
  },
  {
    team: 'New Orleans Pelicans',
    tier: 'Playoff mix',
    note: 'Zion Williamson and Brandon Ingram both cleared exit physicals without restrictions, Trey Murphy III locked in an extension, and a healthy Dyson Daniels backcourt adds the point-of-attack stopper they lacked.',
  },
  {
    team: 'Miami Heat',
    tier: 'Playoff mix',
    note: 'Jimmy Butler is on a load-managed ramp but healthy, Bam Adebayo re-upped long term, and Terry Rozier plus rookie Kel’el Ware finally give Miami size and shot creation in one package.',
  },
  {
    team: 'Golden State Warriors',
    tier: 'Playoff mix',
    note: 'Stephen Curry and Draymond Green took a lighter Team USA summer, Jonathan Kuminga’s late-season surge pushed him into a starting forward slot, and De’Anthony Melton adds the two-way guard the rotation missed.',
  },
  {
    team: 'Los Angeles Clippers',
    tier: 'Playoff mix',
    note: 'Kawhi Leonard and Paul George are both entering contract years with clean bills of health, James Harden embraced a full-time facilitator role, and Daniel Theis plus P.J. Tucker keep the defense switchy.',
  },
  {
    team: 'Houston Rockets',
    tier: 'Play-in push',
    note: 'Alperen Şengün’s All-Star breakout drives the half-court, Jalen Green’s shot diet improved post All-Star, and Dillon Brooks with Amen Thompson headline a defense aiming for top-10 efficiency.',
  },
  {
    team: 'Atlanta Hawks',
    tier: 'Play-in push',
    note: 'Trae Young and Jalen Johnson are the offensive engine, new coach Jordi Fernández is leaning into pace and length, and rookie Zaccharie Risacher expands the wing size they lacked.',
  },
  {
    team: 'Indiana Pacers',
    tier: 'Play-in fight',
    note: 'With Tyrese Haliburton sidelined all season after Achilles surgery, Pascal Siakam and Bennedict Mathurin shoulder primary creation while Andrew Nembhard captains the fast-break-heavy identity.',
  },
  {
    team: 'Utah Jazz',
    tier: 'Play-in fight',
    note: 'Lauri Markkanen remains the focal point amid extension talks, Walker Kessler’s summer with Finland sharpened his rim protection, and Keyonte George’s pick-and-roll polish gives Utah a higher offensive ceiling.',
  },
  {
    team: 'San Antonio Spurs',
    tier: 'Play-in swing',
    note: 'Victor Wembanyama’s sophomore leap includes added muscle and playmaking, Devin Vassell is healthy, and veteran point guard Malcolm Brogdon bridges the spacing issues that stalled last winter.',
  },
  {
    team: 'Chicago Bulls',
    tier: 'Rebuild watch',
    note: 'Coby White and Josh Giddey headline a jumbo creator pairing while Lonzo Ball remains shelved, Patrick Williams is back on a prove-it deal, and the front office is prioritizing long-term development minutes.',
  },
  {
    team: 'Toronto Raptors',
    tier: 'Rebuild watch',
    note: 'Scottie Barnes runs point full-time, Immanuel Quickley’s new contract keeps creation in-house, and a rookie frontcourt of Zach Edey and Gradey Dick minutes signals an extended development runway.',
  },
  {
    team: 'Detroit Pistons',
    tier: 'Growth track',
    note: 'Cade Cunningham inked his max extension, Ausar Thompson’s shooting gains from USA Select camp are translating, and new coach J.B. Bickerstaff is leaning on veterans to stabilize late-game execution.',
  },
  {
    team: 'Charlotte Hornets',
    tier: 'Growth track',
    note: 'LaMelo Ball is cleared for full participation, Brandon Miller is moving into a featured scoring role, and Charles Lee added veteran center Jonas Valančiūnas to steady the glass.',
  },
  {
    team: 'Portland Trail Blazers',
    tier: 'Growth track',
    note: 'Scoot Henderson’s finishing jump and Shaedon Sharpe’s healthy shoulder headline year-two leaps, rookie Donovan Clingan fortifies the rim, and Portland remains focused on developmental reps.',
  },
  {
    team: 'Washington Wizards',
    tier: 'Development runway',
    note: 'Top pick Alex Sarr joins Bilal Coulibaly and Deni Avdija in a length-heavy core, veteran Tyus Jones keeps the offense organized, and Jordan Poole shifts into a microwave sixth-man role.',
  },
  {
    team: 'Brooklyn Nets',
    tier: 'Development runway',
    note: 'With Mikal Bridges traded at the deadline, Cam Thomas and Dariq Whitehead headline a youth-first reset, newly acquired picks fuel patience, and Sean Marks handed Jordi Fernández a long runway.',
  },
];
