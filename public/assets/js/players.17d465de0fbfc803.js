var C=new URL("./data/rosters.json",document.baseURI).toString();async function B(){let e=await fetch(C,{cache:"no-store"});if(!e.ok)throw new Error(`Request failed with status ${e.status}`);return await e.json()}var f=document.getElementById("players-app");if(!f)throw new Error("Missing #players-app container");var F=new URLSearchParams(window.location.search),j,k=((j=F.get("team"))!=null?j:"").toUpperCase(),E,q=(E=F.get("search"))!=null?E:"",r={doc:null,loading:!0,error:null,searchTerm:q,teamFilter:k,anchorApplied:!1};function p(e){return e.replace(/[&<>"']/g,t=>{switch(t){case"&":return"&amp;";case"<":return"&lt;";case">":return"&gt;";case'"':return"&quot;";case"'":return"&#39;";default:return t}})}function O(e){let t=Date.parse(e);if(Number.isNaN(t))return e;let s=Date.now(),a=Math.round((t-s)/1e3),o=[{amount:60,unit:"second"},{amount:60,unit:"minute"},{amount:24,unit:"hour"},{amount:7,unit:"day"},{amount:4.34524,unit:"week"},{amount:12,unit:"month"},{amount:Number.POSITIVE_INFINITY,unit:"year"}],l=new Intl.RelativeTimeFormat("en",{numeric:"auto"}),i=a;for(let u of o){if(Math.abs(i)<u.amount)return l.format(Math.round(i),u.unit);i/=u.amount}return l.format(Math.round(i),"year")}function V(e,t){if(!t)return!0;let s=t.toLowerCase(),a=e.name.toLowerCase(),o=e.jersey?`#${e.jersey}`.toLowerCase():"";return a.includes(s)||o.includes(s)}function y(e){let t=new URL(window.location.href);Object.entries(e).forEach(([s,a])=>{a&&a.length?t.searchParams.set(s,a):t.searchParams.delete(s)}),window.history.replaceState({},"",t.toString())}function x(e){var s;let t=(s=e.source)==null?void 0:s.trim().toLowerCase();return t==="ball_dont_lie"?"Ball Don't Lie":t==="manual_roster_reference"?"Manual roster reference":e.source&&e.source.trim().length?e.source.trim():"Unknown"}function Y(e){var s;let t=(s=e.season)==null?void 0:s.trim();if(t)return t;if(typeof e.season_start_year=="number"&&Number.isFinite(e.season_start_year)){let a=e.season_start_year,o=String(a+1).slice(-2);return`${a}-${o}`}return"2025-26"}function z(e){return e.abbr==="FA"?"Free agents":e.name||e.abbr}function G(e,t){return e==="FA"&&t!=="FA"?1:t==="FA"&&e!=="FA"?-1:e.localeCompare(t)}function J(e,t){var o,l,i,u,d,h;let s=((o=e.abbreviation)==null?void 0:o.trim().toUpperCase())||"FA",a=((l=e.full_name)==null?void 0:l.trim())||s;return{id:t.id,name:`${t.first_name} ${t.last_name}`.trim(),team_abbr:s,team_name:a,position:(i=t.position)!=null?i:null,jersey:(u=t.jersey_number)!=null?u:null,height:(d=t.height)!=null?d:null,weight:(h=t.weight)!=null?h:null}}function K(e){var s,a;let t=[];for(let o of Array.isArray(e.teams)?e.teams:[]){let l=((s=o.abbreviation)==null?void 0:s.trim().toUpperCase())||"FA",i=((a=o.full_name)==null?void 0:a.trim())||l,u=(Array.isArray(o.roster)?o.roster:[]).map(d=>J(o,d)).sort((d,h)=>d.name.localeCompare(h.name));t.push({abbr:l,name:i,players:u})}return t.sort((o,l)=>G(o.abbr,l.abbr))}function Q(){f.innerHTML=`
  ...
  `,D=o.map(n=>{let c=n.players.filter(m=>V(m,r.searchTerm)),T=c.map(m=>{var S,A;let N=m.jersey?`#${m.jersey}`:"",$=[(S=m.position)!=null?S:"",N].filter(Boolean).join(" \xB7 "),L=[(A=m.height)!=null?A:"",m.weight?`${m.weight} lb`:""].filter(Boolean).join(" \u2022 ");return`
          ...
          `}).join(""),P=c.length?"":'<li class="roster-player roster-player--empty">No players match this filter.</li>',H=`${p(z(n))} \xB7 ${c.length} players`;return`
      ...
      `}).join(""),g="";i?o.length||(g='<div class="roster-status roster-status--empty"><p>No teams match the current filter.</p></div>'):g='<div class="roster-status roster-status--empty"><p>Rosters are not cached yet. Use Refresh to try again.</p></div>',f.innerHTML=`${U}<div class="roster-teams">${D}${g}</div>`;let w=document.getElementById("roster-search"),R=document.getElementById("roster-team"),v=f.querySelector("[data-roster-refresh]");if(w&&w.addEventListener("input",n=>{let c=n.target.value;r.searchTerm=c,y({search:c}),b()}),R&&R.addEventListener("change",n=>{let c=n.target.value.toUpperCase();r.teamFilter=c,r.anchorApplied=!c,y({team:c}),b()}),v&&v.addEventListener("click",()=>_()),!r.anchorApplied&&r.teamFilter){let n=f.querySelector(`[data-team-anchor="${r.teamFilter}"]`);n&&(n.scrollIntoView({behavior:"smooth",block:"start"}),r.anchorApplied=!0)}}function b(){if(r.loading){Q();return}if(r.error){W(r.error);return}r.doc&&X(r.doc)}async function _(){r.loading=!0,r.error=null,b();try{let e=await B();if(!e||!Array.isArray(e.teams))throw new Error("Malformed roster payload");r.doc=e,r.loading=!1,b()}catch(e){r.loading=!1,r.error=e instanceof Error?e.message:"Unable to load players.",b()}}_();
